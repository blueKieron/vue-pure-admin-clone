...
// var removeLeftSpace = e => e.replace(/^\s*/, ""),
//     removeRightSpace = e => e.replace(/(\s*$)/g, ""),
//     removeBothSidesSpace = e => e.replace(/^\s*|\s*$/g, ""),
...
//     if (Ne(e) && Ne(t)) return setsEqual(e, t);
...
//                     let x = m[b];
//                     if (!shouldCleanKey(b, x, t)) continue;
//                     let T = u(x, f + 1, b, m);
//                     T !== void 0 && (l[b] = T, d = !0);
//                 }
...
//   removeBothSidesSpace as removeBothSidesSpace, removeClass as removeClass, removeLeftSpace as removeLeftSpace, removeRightSpace as removeRightSpace, rgbToHex as rgbToHex, setsEqual as setsEqual, shouldCleanKey as shouldCleanKey, shuffleArray as shuffleArray, splitNum as splitNum, storageLocal as storageLocal, storageSession as storageSession, subAfter as subAfter, subBefore as subBefore, subBetween as subBetween, subBothSides as subBothSides, subTextAddEllipsis as subTextAddEllipsis, subtraction as subtraction,
//   sum as sum, swapOrder as swapOrder, throttle as throttle, toSet as toSet, toggleClass as toggleClass, urlToBase64 as urlToBase64, useAttrs as useAttrs, useCopyToClipboard as useCopyToClipboard, useDark as useDark, useDraggable as useDraggable, useDynamicComponent as useDynamicComponent, useECharts as useECharts, useGlobal as useGlobal,
...
const objectTypeToString = Object.prototype.toString;
function is(e, t) {
  return objectTypeToString.call(e) === `[object ${t}]`;
}
...
const storageLocal = () =>
  isClient
    ? new LocalStorageManager(window.localStorage)
    : new LocalStorageManager("");
const storageSession = () =>
  isClient ? new StorageManager(window.sessionStorage) : new StorageManager("");
